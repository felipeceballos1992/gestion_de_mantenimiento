...
CREATE TABLE `cronograma` (
  ...
  CONSTRAINT `cronograma_ibfk_1` FOREIGN KEY (`equipo_id`) REFERENCES `equipos` (`id`)
...
CREATE TABLE `fotos_mantenimiento` (
  ...
  CONSTRAINT `fotos_mantenimiento_ibfk_1` FOREIGN KEY (`mantenimiento_id`) REFERENCES `mantenimientos` (`id`)
...
LOCK TABLES `fotos_mantenimiento` WRITE;
/*!40000 ALTER TABLE `fotos_mantenimiento` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `fotos_mantenimiento` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `mantenimientos` (
  ...
  CONSTRAINT `fk_mantenimientos_cronograma` FOREIGN KEY (`cronograma_id`) REFERENCES `cronograma` (`id`),
...
CREATE TABLE `repuestos` (
  ...
  PRIMARY KEY (`id`),
  KEY `mantenimiento_id` (`mantenimiento_id`),
  CONSTRAINT `repuestos_ibfk_1` FOREIGN KEY (`mantenimiento_id`) REFERENCES `mantenimientos` (`id`)
...
-- Dump completed on 2025-11-21 21:58:14
